...
ensure_value ".env" "TRANSLATOR_PORT" "5001"
...
ensure_value ".env" "FALLBACK_PROFIT_MARGIN" "0.35"
ensure_value ".env" "PRODUCT_LANGUAGES" "en,ukr"
ensure_value ".env" "AUTO_TRANSLATE_PRODUCTS" "true"
ensure_value ".env" "TRANSLATION_ENABLED" "true"
ensure_value ".env" "TRANSLATION_TIMEOUT_SECONDS" "3"
ensure_value ".env" "TRANSLATION_SOURCE_LANGUAGE" "en"
ensure_value ".env" "ACCESS_TOKEN_LIFETIME_SECONDS" "2592000"
...
TRANSLATOR_PORT="$(read_env_value ".env" "TRANSLATOR_PORT")"
...
FALLBACK_PROFIT_MARGIN="$(read_env_value ".env" "FALLBACK_PROFIT_MARGIN")"
PRODUCT_LANGUAGES="$(read_env_value ".env" "PRODUCT_LANGUAGES")"
AUTO_TRANSLATE_PRODUCTS="$(read_env_value ".env" "AUTO_TRANSLATE_PRODUCTS")"
TRANSLATION_ENABLED="$(read_env_value ".env" "TRANSLATION_ENABLED")"
TRANSLATION_TIMEOUT_SECONDS="$(read_env_value ".env" "TRANSLATION_TIMEOUT_SECONDS")"
TRANSLATION_SOURCE_LANGUAGE="$(read_env_value ".env" "TRANSLATION_SOURCE_LANGUAGE")"
ACCESS_TOKEN_LIFETIME_SECONDS="$(read_env_value ".env" "ACCESS_TOKEN_LIFETIME_SECONDS")"
...
write_env_value "back-end/.env" "APP_CONFIG__ACCESS_TOKEN__LIFETIME_SECONDS" "$ACCESS_TOKEN_LIFETIME_SECONDS"
...
write_env_value "back-end/.env" "APP_CONFIG__PROFIT__FALLBACK_MARGIN" "$FALLBACK_PROFIT_MARGIN"
write_env_value "back-end/.env" "APP_CONFIG__PRODUCT_LANGUAGES__SUPPORTED_LANGUAGES" "$PRODUCT_LANGUAGES"
write_env_value "back-end/.env" "APP_CONFIG__PRODUCT_LANGUAGES__AUTO_TRANSLATE_PRODUCTS" "$AUTO_TRANSLATE_PRODUCTS"
write_env_value "back-end/.env" "APP_CONFIG__TRANSLATION__ENABLED" "$TRANSLATION_ENABLED"
write_env_value "back-end/.env" "APP_CONFIG__TRANSLATION__BASE_URL" "http://localhost:${TRANSLATOR_PORT}"
write_env_value "back-end/.env" "APP_CONFIG__TRANSLATION__TIMEOUT_SECONDS" "$TRANSLATION_TIMEOUT_SECONDS"
write_env_value "back-end/.env" "APP_CONFIG__TRANSLATION__SOURCE_LANGUAGE" "$TRANSLATION_SOURCE_LANGUAGE"
